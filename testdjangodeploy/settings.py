"""
Django settings for testdjangodeploy project.
...
SECRET_KEY = "django-insecure-kvp65$@te7oku(u&j27@s#9_ncm%w6xi)pvg-b&z5b$-^exugs"
...
ROOT_URLCONF = "testdjangodeploy.urls"
...
WSGI_APPLICATION = "testdjangodeploy.wsgi.application"
